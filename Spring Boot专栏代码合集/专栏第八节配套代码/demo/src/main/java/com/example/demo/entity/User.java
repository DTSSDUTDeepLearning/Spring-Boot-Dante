...
public class User {
    ...
    public User(int user_id, double user_wallet) {
        this.user_id = user_id;
    ...
    public User(String user_name, String user_phone, String user_password, double user_wallet, String register_time, String login_time) {
        this.user_name = user_name;
