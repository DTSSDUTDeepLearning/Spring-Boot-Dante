...
public class TestController {
    ...
    @RequestMapping(value = "/sqlMethod", method = {RequestMethod.POST,RequestMethod.GET})
    public List<Map<String, Object>> secondMethod() {
        String sql = "select * from user_";
        return JdbcTemplate.queryForList(sql);
    }

    @RequestMapping(value = "/sqlMethod_parameter", method = {RequestMethod.POST,RequestMethod.GET})
    ...
    @RequestMapping(value = "/sqlMethod_parameters", method = {RequestMethod.POST,RequestMethod.GET})
